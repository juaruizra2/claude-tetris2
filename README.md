...
- **Tuerca** (_nut_): pieza de reto 3×3 con un hueco vacío en el centro (gris metálico). Aparece rara vez (~10% de las piezas) y deja un agujero que solo se puede rellenar entrando por el lateral.
...
| `NUT_CHANCE`   | Probabilidad de que salga la tuerca      | `0.10`                |
